...
/*
	...
	cout << "один киллограм ирисок дороже шоколада в " << (a / x) / (b / y) << "раз" << endl;
*/
	int V, T1, T2, S1, S2;
	signed int U;
	cout << "введите скорость лодки: "; cin >> V; cout << endl;
	cout << "введите скорость течения реки: "; cin >> U; cout << endl;
	cout << "введите время лодки по озеру: "; cin >> T1; cout << endl;
	cout << "введите время лодки по реке: "; cin >> T2; cout << endl;
	S1 = (V * T1) + ((V + U) * T2);
	cout << "путь в одном направлении с течением: " << S1 << " (при значении скорости реки "<< U << ")" << endl;
	S2 = (V * T1) + ((V - U) * T2);
	cout << "путь в противоположном направлении: " << S2 << " (при значении скорости реки " << U << ")" << endl;
